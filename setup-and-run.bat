@echo off
echo ========================================
echo    Todo Calendar App Setup & Run
echo ========================================
echo.
...
start "Todo Calendar Backend" cmd /k "cd /d %~dp0backend && call venv\Scripts\activate && python main.py"
...
echo.
echo 🎉 Your Todo Calendar App is ready!
echo.
echo 📝 Instructions:
...
echo - To run again later, just use: run-app.bat
echo.
pause 